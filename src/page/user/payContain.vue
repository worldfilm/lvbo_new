...
<div class="pay">
  <div class="pay-layer-container">
    <div class="pay-layer-close  close" @click='closed'><i class="iconfont icon-guanbi"></i> </div>
    ...
    <div class="layer-package">
      ...
      <div class="layer-package-container clearfix">
        <ul>
          <li class="layer-package-content" v-for="(item,index) in list" @click='chosepay(index)' :class="{artivec:index == num}">
...
export default {
  data() {
    return {
      ...
      weixin: false,
      username:null,
      headimg:sessionStorage.getItem('imgsrc'),
      list: [{
          name: '7天vip',
          month: '',
          moneyy: '30.00',
