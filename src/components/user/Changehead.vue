...
<div class="Changehead">
  ...
  <div class="Info-box">
    ...
    <div class="personal-info">
      ...
      <ul>
        <li v-for='(item,index) in list' @click='handclick(index,item.id,item.img_url)' :key="index"><span :class="{ 'fas fa-check-circle activeimg':index==numing}"></span><img :src="item.img_url" alt=""></li>
      </ul>
      <p class="surep">
